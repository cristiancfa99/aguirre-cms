...
type P = { name: string; description: string; thumbnail: string | null; badge: string | null; iconKey: string | null };
      ...
      {products.map((p, i) => {
        ...
        return (
          <div className="pcard" key={i}>
            {p.thumbnail ? (
              <div className="ph"><img src={p.thumbnail} alt={p.name} loading="lazy" />{p.badge && <span className="badge">{p.badge}</span>}</div>
            ) : (
